    ...
    <Modal
      ...
      <div className="post-modal-content">
        <style>{`
          ...
          /* POST BUTTON STYLE (White text on Blue) */
          .send-btn {
          ...
          @media (max-width: 768px) {
            ...
            /* The outer wrapper for media on mobile */
            .post-modal-media {
               width: 100% !important;
            ...
            /* Flex container for slides: Row direction, align start */
            .post-modal-carousel__container {
               display: flex !important; 
               flex-direction: row !important;
               /* IMPORTANT: Prevents shorter images from stretching to tallest height */
            ...
            /* Single slide takes 100% width, auto height */
            ...
            /* Image itself: Full width, natural height */
            .post-modal-media img, 
            .post-modal-media video {
               width: 100% !important;
               height: auto !important;
