...
const TEXT_COMMENT_PLACEHOLDER =
  "\u09AE\u09A8\u09CD\u09A4\u09AC\u09CD\u09AF \u09B2\u09BF\u0996\u09C1\u09A8...";
const TEXT_SUBMIT_COMMENT = "পোস্ট"; // Shortened for button
  ...
  return (
    <Modal
      ...
      <div className="post-modal-content">
        ...
        <style>{`
          /* 1. Reset Media Container Padding (Desktop & Mobile) */
          .post-modal-media {
            padding: 0 !important;
            margin: 0 !important;
          ...
          .comment-input-area {
            ...
            /* Keep original BG (inherited) */
          }

          .comment-input-area textarea {
            flex: 1;
            background: #f1f5f9; /* Light Pill Color */
            border: none;
          ...
          @media (max-width: 768px) {
            ...
            /* Images take natural height on mobile */
