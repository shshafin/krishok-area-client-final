        ...
        <style>{`
          ...
          @media (max-width: 768px) {
            .post-modal-content {
              ...
              padding: 0 !important; /* Ensure no padding on main container */
            }
            
            /* --- FIXED MOBILE CAROUSEL --- */
            /* Restore Flexbox so slides sit side-by-side (Carousel Effect) */
            .post-modal-carousel,
            .post-modal-carousel__viewport {
                width: 100% !important;
                height: auto !important;
                min-height: 0 !important;
                overflow: hidden !important; /* Mask other slides */
            }
            ...
            .post-modal-comments {
              ...
              height: auto !important;
              padding: 0 15px 20px 15px; /* Add padding only to comments */
            }
