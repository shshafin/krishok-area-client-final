  ...
  return (
    <Modal
      ...
      <div className="post-modal-content">
        {/* --- GLOBAL STYLES (Applies to both Desktop & Mobile) --- */}
        <style>{`
          /* 1. HIDE SCROLLBARS GLOBALLY */
          .post-modal-content, .comment-list, .post-likes-list {
          ...
          /* 2. RESET MEDIA (NO GAPS, EXACT SIZE) */
          .post-modal-media {
            padding: 0 !important;
            margin: 0 !important;
            background-color: transparent !important; /* No black bars */
            display: flex;
            align-items: center;
            justify-content: center;
            flex-grow: 0 !important; /* Don't force stretch */
            height: auto !important; /* Fit image height */
            width: 100% !important;
          }
          
          /* Full width/height, crop if needed or fit perfectly */
          .post-modal-media img, 
          .post-modal-media video {
            width: 100% !important;
            height: auto !important;
            max-height: 85vh; /* Max height constraint */
            object-fit: contain;
            display: block;
            margin: 0 auto;
          }

          /* 3. MODERN DARK INPUT DESIGN */
          .comment-input-area {
            display: flex;
            align-items: center;
            gap: 10px;
          ...
          @media (max-width: 768px) {
            ...
            .post-modal-media img, 
            .post-modal-media video {
               max-height: none !important; /* Unrestricted height on mobile */
            }
