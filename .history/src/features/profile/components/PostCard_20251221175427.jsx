...
export default function PostCard({
  ...
  const { normalizedGallery, displayAuthor } = useMemo(() => {
    ...
    const userObj = post.user || {}; // Raw Backend Data
    const authObj = post.author || {}; // Frontend Data

    // PRIORITY: Backend Name > Frontend Name > Username
    const realName =
      userObj.name ||
      authObj.name ||
      userObj.username ||
  ...
  return (
    <article
      ...
      {/* ACTION BUTTONS (LIKE/COMMENT) - FIXED Z-INDEX & EVENTS */}
      <div
