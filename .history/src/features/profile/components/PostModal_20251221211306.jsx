...
export default function PostModal({
  ...
  // Media style for desktop (default)
  const mediaStyle = {
    width: "100%",
    height: "100%",
    objectFit: "contain",
      ...
      <div className="post-modal-content">
        ...
        <style>{`
          @media (max-width: 768px) {
            /* 1. Make the main content scrolling + Hide Scrollbar */
            .post-modal-content {
            ...
            /* 2. Media at top, auto height (No unnecessary gaps) */
            .post-modal-media {
            ...
            /* Fix Carousel Slide Heights on Mobile - Auto height */
            .post-modal-carousel__slide {
               height: auto !important; 
               min-height: 0 !important;
            }
            
            /* Force images/videos to be auto height inside mobile modal */
            .post-modal-media img, .post-modal-media video {
               height: auto !important;
               width: 100% !important;
               max-height: 80vh !important; /* Cap it slightly so it fits on screen nicely */
            ...
            /* 4. Sticky Input at Bottom - Original BG Color */
            .comment-input-area {
              position: sticky !important;
              bottom: 0;
              z-index: 50;
              /* REMOVED background: #fff; to restore your original design */
              /* Ensure padding looks okay on mobile */
              padding: 10px !important;
              border-top: 1px solid #2e353f; /* Darker border for dark mode or just a separator */
            }
          }
        `}</style>
