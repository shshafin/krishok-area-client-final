...
// --- Helper for Bangla Time ---
const formatTimeAgoBangla = (dateString) => {
  const timeStr = format(dateString); // "5 minutes ago"
  ...
  return (
    timeStr
      ...
      .replace("in ", "") // Future tense cleanup if needed
      // Digits
      .replace(/0/g, "০")
      .replace(/1/g, "১")
      .replace(/2/g, "২")
      ...
      <header className="post-card-header">
        <NavLink
          ...
          <div className="post-card-author">
            {/* CHANGED: Use post.author.name explicitly */}
            <h5>{post.author.name}</h5>
            {/* CHANGED: Use helper for Bangla time */}
