...
export default function PostModal({
  ...
  useEffect(() => {
    ...
    const updateHeight = () => {
      ...
      if (currentSlide) {
        // Find image or video inside the slide to get exact content height
        const media = currentSlide.querySelector("img, video");
        if (media) {
          // If image is loaded, use its height. If not, use slide height.
        ...
        // Fallback
        setCarouselHeight(`${currentSlide.getBoundingClientRect().height}px`);
      }
    };
