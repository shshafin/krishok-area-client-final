...
const TEXT_COMMENT_PLACEHOLDER =
  "\u09AE\u09A8\u09CD\u09A4\u09AC\u09CD\u09AF \u09B2\u09BF\u0996\u09C1\u09A8...";
const TEXT_SUBMIT_BTN_LABEL = "পোস্ট"; // Fixed: Bangla Text "Post"
  ...
  return (
    <Modal
      ...
      <div className="post-modal-content">
        <style>{`
          /* 1. HIDE SCROLLBARS GLOBALLY (Desktop & Mobile) */
          .post-modal-content, 
          .comment-list, 
          .post-likes-list,
          .post-modal-comments {
          ...
          /* 2. MEDIA LAYOUT (Full width, no padding) */
          .post-modal-media {
            padding: 0 !important;
            margin: 0 !important;
          ...
          /* Desktop Specific Constraint: Limit max height so it fits in modal */
          @media (min-width: 769px) {
             .post-modal-media img, 
             .post-modal-media video {
                max-height: 85vh; /* Keep within viewport on desktop */
             }
          }
          ...
          @media (max-width: 768px) {
            ...
            /* RESET CAROUSEL CONTAINERS TO AUTO HEIGHT */
            /* This is the key fix for "Image not showing" */
            .post-modal-carousel,
            ...
            /* Force images/videos to be visible */
            .post-modal-media img, 
            .post-modal-media video {
               width: 100% !important;
               height: auto !important;
