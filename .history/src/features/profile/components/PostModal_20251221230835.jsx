...
export default function PostModal({
  ...
  useEffect(() => {
    ...
    // Also listen for image loads or window resizes to adjust height
        ...
        <style>{`
          ...
          @media (max-width: 768px) {
            ...
            .post-modal-carousel__container {
               ...
               /* FIX: Align start prevents stretching shorter slides */
          ...
          {slides.length > 0 ? (
            <div className="post-modal-carousel">
              <div
                ...
                ref={emblaRef}
                // APPLIED DYNAMIC HEIGHT (Mobile Only logic handled via CSS targeting)
                // We use inline style here, but it's safe because desktop CSS overrides won't use this if media queries are set right,
                // or we can apply it only conditionally. Since desktop uses max-height 85vh, let's let this run.
