    ...
    <Modal
      ...
      <div className="post-modal-content">
        <style>{`
          ...
          /* 2. DESKTOP MEDIA (Limited height) */
          .post-modal-media {
            padding: 0 !important;
            margin: 0 !important;
          ...
          /* --- BUTTON STYLE (Blue with White Text) --- */
          .send-btn {
          ...
          @media (max-width: 768px) {
            ...
            /* Restore Flexbox so slides sit side-by-side */
            ...
            .post-modal-carousel__slide {
               flex: 0 0 100% !important; /* Force single slide width */
