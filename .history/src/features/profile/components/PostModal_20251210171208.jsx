...
export default function PostModal({
  ...
  post,
  mode,
  // MODIFIED: Accept initialSlideIndex from PostCard
  initialSlideIndex = 0,
  onClose,
  onToggleLike,
  onAddComment,
  ...
  // MODIFIED: Pass initialSlideIndex to Embla Carousel
  const [emblaRef] = useEmblaCarousel(
    {
      align: "start",
      loop: useCarousel,
      // FIX 1: Start on the slide index passed from PostCard
    ...
    <Modal
      ...
      <div className="post-modal-content">
        <div
          ...
          // FIX 2: Apply styles to the media container to ensure full size
          style={{
            flexGrow: 1, // Ensures media takes up maximum horizontal space
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            height: "100%", // Ensures it fills the modal content height
            maxHeight: "80vh", // Prevent media from getting too tall
            // Added background for visual clarity, can be removed if CSS handles it
            backgroundColor: "#000",
          }}>
          {hasVideo ? (
            <video
              ...
              controls
              loop
              // FIX 2: Added object-fit for video
            ...
            useCarousel ? (
              <div className="post-modal-carousel">
                <div
                  ...
                  <div
                    ...
                    // FIX 2: Added styles to carousel container for full height/width
                    style={{ height: "100%" }}>
                    {galleryImages.map((item, index) => {
                      ...
                      return (
                        <div
                          ...
                          key={key}
                          // FIX 2: Added styles to carousel slide for full height/width
                          style={{ height: "100%" }}>
                          <img
                            src={item.src}
                            alt={post.content || TEXT_MEDIA_ALT}
                            // FIX 2: Critical style for image sizing
                            style={{
                              width: "100%",
                              height: "100%",
                              objectFit: "contain",
              ...
              <img
                ...
                alt={post.content || TEXT_MEDIA_ALT}
                // FIX 2: Critical style for single image sizing
                style={{ width: "100%", height: "100%", objectFit: "contain" }}
              />
            )
          ) : null}
...
PostModal.propTypes = {
  ...
  // MODIFIED: Added initialSlideIndex to prop types
...
PostModal.defaultProps = {
  ...
  post: null,
  mode: "comments",
  initialSlideIndex: 0, // Default to 0
  onClose: undefined,
