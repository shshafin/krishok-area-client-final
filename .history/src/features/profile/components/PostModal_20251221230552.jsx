    ...
    <Modal
      ...
      <div className="post-modal-content">
        ...
        <style>{`
          ...
          /* POST BUTTON STYLE (Blue background, White text) */
          .send-btn {
          ...
          /* 4. MOBILE SPECIFIC OVERRIDES - THE FIX */
          @media (max-width: 768px) {
            ...
            /* FORCE AUTO HEIGHT ON EVERYTHING TO FIT IMAGE EXACTLY */
            .post-modal-media,
            .post-modal-carousel,
            ...
            /* Container: Align Start (Prevent stretching), Auto Height */
            .post-modal-carousel__container {
               display: flex !important; 
               flex-direction: row !important;
               align-items: flex-start !important; /* CRITICAL FIX: Stops expanding to tallest slide */
               height: auto !important;
               width: 100% !important;
            ...
            .post-modal-carousel__slide {
               ...
               height: auto !important; /* Fit image */
               display: block !important;
               padding: 0 !important;
            }
            
            /* Image: Full Width, Contain, Natural Height */
            .post-modal-media img, 
            .post-modal-media video {
               width: 100% !important;
               height: auto !important;
