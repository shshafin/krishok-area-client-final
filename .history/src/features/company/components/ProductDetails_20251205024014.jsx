    ...
    <div style={{ marginTop: "5rem" }}>
      ...
      <div className="product-details-tablesize">
        <div className="product-details-tabletitle">
          ...
          {/* UPDATED STYLE: 
            Added inline 'gridTemplateColumns: "1fr"' to force single column on Desktop.
          */}
          <div
            className="product-details-cardgrid"
            style={{
              display: "grid",
              gridTemplateColumns: "1fr", // Forces 1 column on all devices
              gap: "15px", // Gap between the main large blocks
            }}>
              ...
              <article
                ...
                <div
                  ...
                  style={{
                    ...
                    gap: "0", // Removed gap between internal rows
                    padding: "0",
                    overflow: "hidden",
                  }}>
                  {/* 1. Foshol */}
