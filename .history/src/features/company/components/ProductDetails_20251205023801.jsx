          ...
          <div className="product-details-cardgrid">
            ...
            {fosholList.map((crop, index) => (
              <article
                ...
                {/* Container for this specific Index (e.g., Index 0).
                  Contains 4 plain rows: Crop, Pest, Dose, Usage.
                */}
                <div
                  ...
                  style={{
                    ...
                    gap: "0", // Gap handled by the cropcards usually, or set small gap
                    padding: "0", // Remove padding to look like a solid block if needed
                    overflow: "hidden",
                  }}>
                  {/* 1. Foshol */}
                  <div
